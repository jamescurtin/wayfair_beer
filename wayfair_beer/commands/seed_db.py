...
def add_offices():
    copley = Office(office_code="MA_Boston_4", office_name="Boston-Copley Place")
    db.session.add(copley)
    db.session.commit()


def add_keglocations():
    second = KegLocation(office_id=1, location_name="Second Floor Kitchen")
...
def add_taps():
    all_taps = {
        1: [(1, "Far Left"), (2, "Middle Left"), (3, "Middle Right"), (4, "Far Right")],
        2: [(1, "Far Left"), (2, "Middle Left"), (3, "Middle Right"), (4, "Far Right")],
        3: [(1, "Far Left"), (2, "Middle Left"), (3, "Middle Right"), (4, "Far Right")],
        4: [(1, "Left"), (2, "Center"), (3, "Right")],
        5: [(1, "Left"), (2, "Right")],
    }
